...
TlObject _readObject(BinaryReader reader) {
  ...
  if (id == 0xfd3cdab8) {
    return CommunityForbidden.deserialize(reader);
  }

  if (id == 0x65efe954) {
    return Community.deserialize(reader);
  }
  ...
  if (id == 0xcbb7a507) {
    return CommunityFull.deserialize(reader);
  }
  ...
  if (id == 0x8a53b014) {
    return MessageMediaToDo.deserialize(reader);
  }

  if (id == 0xca5cab89) {
    return MessageMediaVideoStream.deserialize(reader);
  }
  ...
  if (id == 0xac1f1fcd) {
    return MessageActionPaidMessagesRefunded.deserialize(reader);
  }

  if (id == 0x84b88578) {
    return MessageActionPaidMessagesPrice.deserialize(reader);
  }

  if (id == 0x2ffe2f7a) {
    return MessageActionConferenceCall.deserialize(reader);
  }

  if (id == 0xcc7c5c89) {
    return MessageActionTodoCompletions.deserialize(reader);
  }

  if (id == 0xc7edbc83) {
    return MessageActionTodoAppendTasks.deserialize(reader);
  }

  if (id == 0xee7a1596) {
    return MessageActionSuggestedPostApproval.deserialize(reader);
  }

  if (id == 0x95ddcf69) {
    return MessageActionSuggestedPostSuccess.deserialize(reader);
  }

  if (id == 0x69f916f8) {
    return MessageActionSuggestedPostRefund.deserialize(reader);
  }

  if (id == 0xa8a3c699) {
    return MessageActionGiftTon.deserialize(reader);
  }
  ...
  if (id == 0xb07ed085) {
    return MessageActionNewCreatorPending.deserialize(reader);
  }

  if (id == 0xe188503b) {
    return MessageActionChangeCreator.deserialize(reader);
  }

  if (id == 0xbf7d6572) {
    return MessageActionNoForwardsToggle.deserialize(reader);
  }
  ...
  if (id == 0xf78a0973) {
    return DialogCommunity.deserialize(reader);
  }
  ...
  if (id == 0x27bb1adc) {
    return InputNotifyCommunity.deserialize(reader);
  }
  ...
  if (id == 0x504aa18f) {
    return UpdateSentPhoneCode.deserialize(reader);
  }

  if (id == 0xa477288f) {
    return UpdateGroupCallChainBlocks.deserialize(reader);
  }

  if (id == 0x77b0e372) {
    return UpdateReadMonoForumInbox.deserialize(reader);
  }

  if (id == 0xa4a79376) {
    return UpdateReadMonoForumOutbox.deserialize(reader);
  }

  if (id == 0x9f812b08) {
    return UpdateMonoForumNoPaidException.deserialize(reader);
  }

  if (id == 0xd8326f0d) {
    return UpdateGroupCallMessage.deserialize(reader);
  }

  if (id == 0xc957a766) {
    return UpdateGroupCallEncryptedMessage.deserialize(reader);
  }

  if (id == 0x683b2c52) {
    return UpdatePinnedForumTopic.deserialize(reader);
  }

  if (id == 0xdef143d0) {
    return UpdatePinnedForumTopics.deserialize(reader);
  }

  if (id == 0x3e85e92c) {
    return UpdateDeleteGroupCallMessages.deserialize(reader);
  }

  if (id == 0x48e246c2) {
    return UpdateStarGiftAuctionState.deserialize(reader);
  }
  ...
  if (id == 0xac072444) {
    return UpdateStarGiftCraftFail.deserialize(reader);
  }
  ...
  if (id == 0xcdd4093d) {
    return UpdateBotGuestChatQuery.deserialize(reader);
  }

  if (id == 0x8c0f91fb) {
    return UpdateAiComposeTones.deserialize(reader);
  }

  if (id == 0xbdac7e70) {
    return UpdateJoinChatWebViewDecision.deserialize(reader);
  }

  if (id == 0xb22083a6) {
    return UpdateNewBotConnection.deserialize(reader);
  }

  if (id == 0xc39a2ade) {
    return UpdateWebBrowserSettings.deserialize(reader);
  }

  if (id == 0x140502d1) {
    return UpdateWebBrowserException.deserialize(reader);
  }

  if (id == 0x20bcbba1) {
    return UpdateNewEphemeralMessage.deserialize(reader);
  }

  if (id == 0x56dbfcf8) {
    return UpdateDeleteEphemeralMessages.deserialize(reader);
  }
  ...
  if (id == 0xbe376999) {
    return NotifyCommunity.deserialize(reader);
  }
  ...
  if (id == 0xbdc597b4) {
    return InputPrivacyKeyNoPaidMessages.deserialize(reader);
  }

  if (id == 0x4dbe9226) {
    return InputPrivacyKeySavedMusic.deserialize(reader);
  }
  ...
  if (id == 0x17d348d2) {
    return PrivacyKeyNoPaidMessages.deserialize(reader);
  }

  if (id == 0xff7a571b) {
    return PrivacyKeySavedMusic.deserialize(reader);
  }
  ...
  if (id == 0x1cf671a0) {
    return InputStickerSetTonGifts.deserialize(reader);
  }
  ...
  if (id == 0xb43df56c) {
    return InputBotInlineMessageRichMessage.deserialize(reader);
  }
  ...
  if (id == 0x0a617e7b) {
    return BotInlineMessageRichMessage.deserialize(reader);
  }
  ...
  if (id == 0x6c24f3dd) {
    return TopPeerCategoryBotsGuestChat.deserialize(reader);
  }
  ...
  if (id == 0x9d2eac97) {
    return TextMath.deserialize(reader);
  }

  if (id == 0xa26156c0) {
    return TextCustomEmoji.deserialize(reader);
  }

  if (id == 0x4c2a5d62) {
    return TextSpoiler.deserialize(reader);
  }

  if (id == 0xcd24cf44) {
    return TextMention.deserialize(reader);
  }

  if (id == 0x519524ea) {
    return TextHashtag.deserialize(reader);
  }

  if (id == 0x02ff29d3) {
    return TextBotCommand.deserialize(reader);
  }

  if (id == 0x7b9e1801) {
    return TextCashtag.deserialize(reader);
  }

  if (id == 0xac6a83aa) {
    return TextAutoUrl.deserialize(reader);
  }

  if (id == 0xc556a45d) {
    return TextAutoEmail.deserialize(reader);
  }

  if (id == 0x24c26789) {
    return TextAutoPhone.deserialize(reader);
  }

  if (id == 0xb956812d) {
    return TextBankCard.deserialize(reader);
  }

  if (id == 0x01a9fbfc) {
    return TextMentionName.deserialize(reader);
  }

  if (id == 0xa5b45e2b) {
    return TextDate.deserialize(reader);
  }
  ...
  if (id == 0xbaff072f) {
    return PageBlockHeading1.deserialize(reader);
  }

  if (id == 0x096b2aec) {
    return PageBlockHeading2.deserialize(reader);
  }

  if (id == 0x67e731ad) {
    return PageBlockHeading3.deserialize(reader);
  }

  if (id == 0xb532772b) {
    return PageBlockHeading4.deserialize(reader);
  }

  if (id == 0xdbbe6c6a) {
    return PageBlockHeading5.deserialize(reader);
  }

  if (id == 0x682a41a9) {
    return PageBlockHeading6.deserialize(reader);
  }

  if (id == 0x59080c20) {
    return PageBlockMath.deserialize(reader);
  }

  if (id == 0x3c29a3e2) {
    return PageBlockThinking.deserialize(reader);
  }

  if (id == 0x574b617f) {
    return InputPageBlockMap.deserialize(reader);
  }
  ...
  if (id == 0x9fbbf1f7) {
    return PhoneCallDiscardReasonMigrateConferenceCall.deserialize(reader);
  }
  ...
  if (id == 0xc517f77e) {
    return ChannelAdminLogEventActionToggleAutotranslation.deserialize(reader);
  }

  if (id == 0x5806b4ec) {
    return ChannelAdminLogEventActionParticipantEditRank.deserialize(reader);
  }
  ...
  if (id == 0x69ef72c4) {
    return InputDialogPeerCommunity.deserialize(reader);
  }
  ...
  if (id == 0x2f65c8e4) {
    return DialogPeerCommunity.deserialize(reader);
  }
  ...
  if (id == 0x7781fe18) {
    return WebPageAttributeAiComposeTone.deserialize(reader);
  }
  ...
  if (id == 0xfe06823f) {
    return InputGroupCallSlug.deserialize(reader);
  }

  if (id == 0x8c10603f) {
    return InputGroupCallInviteMessage.deserialize(reader);
  }
  ...
  if (id == 0x4d818d5d) {
    return InputInvoiceStarGiftUpgrade.deserialize(reader);
  }

  if (id == 0x4a5f5bd9) {
    return InputInvoiceStarGiftTransfer.deserialize(reader);
  }

  if (id == 0xdabab2ef) {
    return InputInvoicePremiumGiftStars.deserialize(reader);
  }
  ...
  if (id == 0x3e77f614) {
    return InputInvoicePremiumAuthCode.deserialize(reader);
  }

  if (id == 0x0923d8d1) {
    return InputInvoiceStarGiftDropOriginalDetails.deserialize(reader);
  }

  if (id == 0x1ecafa10) {
    return InputInvoiceStarGiftAuctionBid.deserialize(reader);
  }
  ...
  if (id == 0x3fc18057) {
    return InputStorePaymentAuthCode.deserialize(reader);
  }
  ...
  if (id == 0x7184603b) {
    return EmojiStatusCollectible.deserialize(reader);
  }

  if (id == 0x07141dbf) {
    return InputEmojiStatusCollectible.deserialize(reader);
  }
  ...
  if (id == 0x69d66c45) {
    return InputReplyToMonoForum.deserialize(reader);
  }

  if (id == 0x4119b95e) {
    return InputReplyToEphemeralMessage.deserialize(reader);
  }
  ...
  if (id == 0x5787686d) {
    return MediaAreaStarGift.deserialize(reader);
  }
  ...
  if (id == 0xb9c0639a) {
    return PeerColorCollectible.deserialize(reader);
  }

  if (id == 0xb8ea86a9) {
    return InputPeerColorCollectible.deserialize(reader);
  }
  ...
  if (id == 0x64407ea7) {
    return MonoForumDialog.deserialize(reader);
  }
  ...
  if (id == 0x74aee3e0) {
    return StarsTonAmount.deserialize(reader);
  }
  ...
  if (id == 0xb0cd6617) {
    return BotVerifierSettings.deserialize(reader);
  }

  if (id == 0xf93cd45c) {
    return BotVerification.deserialize(reader);
  }

  if (id == 0x565251e2) {
    return StarGiftAttributeModel.deserialize(reader);
  }

  if (id == 0x4e7085ea) {
    return StarGiftAttributePattern.deserialize(reader);
  }

  if (id == 0x9f2504e4) {
    return StarGiftAttributeBackdrop.deserialize(reader);
  }

  if (id == 0xe0bff26c) {
    return StarGiftAttributeOriginalDetails.deserialize(reader);
  }

  if (id == 0x3de1dfed) {
    return PaymentsStarGiftUpgradePreview.deserialize(reader);
  }

  if (id == 0x62d706b8) {
    return UsersUsers.deserialize(reader);
  }
  ...
  if (id == 0x95f389b1) {
    return PaymentsSavedStarGifts.deserialize(reader);
  }

  if (id == 0x69279795) {
    return InputSavedStarGiftUser.deserialize(reader);
  }

  if (id == 0xf101aa7f) {
    return InputSavedStarGiftChat.deserialize(reader);
  }

  if (id == 0x2085c238) {
    return InputSavedStarGiftSlug.deserialize(reader);
  }

  if (id == 0x84aa3a9c) {
    return PaymentsStarGiftWithdrawalUrl.deserialize(reader);
  }

  if (id == 0x206ad49e) {
    return PaidReactionPrivacyDefault.deserialize(reader);
  }

  if (id == 0x1f0c1ad9) {
    return PaidReactionPrivacyAnonymous.deserialize(reader);
  }

  if (id == 0xdc6cfcf0) {
    return PaidReactionPrivacyPeer.deserialize(reader);
  }

  if (id == 0x1e109708) {
    return AccountPaidMessagesRevenue.deserialize(reader);
  }

  if (id == 0x050a9839) {
    return RequirementToContactEmpty.deserialize(reader);
  }

  if (id == 0xe581e4e9) {
    return RequirementToContactPremium.deserialize(reader);
  }

  if (id == 0xb4f67e93) {
    return RequirementToContactPaidMessages.deserialize(reader);
  }

  if (id == 0xa0624cf7) {
    return BusinessBotRights.deserialize(reader);
  }

  if (id == 0x71f276c4) {
    return DisallowedGiftsSettings.deserialize(reader);
  }

  if (id == 0xc69708d3) {
    return SponsoredPeer.deserialize(reader);
  }

  if (id == 0xea32b4b1) {
    return ContactsSponsoredPeersEmpty.deserialize(reader);
  }

  if (id == 0xeb032884) {
    return ContactsSponsoredPeers.deserialize(reader);
  }

  if (id == 0x48aaae3c) {
    return StarGiftAttributeIdModel.deserialize(reader);
  }

  if (id == 0x4a162433) {
    return StarGiftAttributeIdPattern.deserialize(reader);
  }

  if (id == 0x1f01c757) {
    return StarGiftAttributeIdBackdrop.deserialize(reader);
  }

  if (id == 0x2eb1b658) {
    return StarGiftAttributeCounter.deserialize(reader);
  }

  if (id == 0x947a12df) {
    return PaymentsResaleStarGifts.deserialize(reader);
  }

  if (id == 0xc387c04e) {
    return StoriesCanSendStoryCount.deserialize(reader);
  }

  if (id == 0xe7e82e12) {
    return PendingSuggestion.deserialize(reader);
  }

  if (id == 0xcba9a52f) {
    return TodoItem.deserialize(reader);
  }

  if (id == 0x49b92a26) {
    return TodoList.deserialize(reader);
  }

  if (id == 0x221bb5e4) {
    return TodoCompletion.deserialize(reader);
  }
  ...
  if (id == 0x99ea331d) {
    return StarGiftUpgradePrice.deserialize(reader);
  }

  if (id == 0x1a8afc7e) {
    return GroupCallMessage.deserialize(reader);
  }

  if (id == 0xee430c85) {
    return GroupCallDonor.deserialize(reader);
  }

  if (id == 0x9d1dbd26) {
    return PhoneGroupCallStars.deserialize(reader);
  }

  if (id == 0x711d692d) {
    return RecentStory.deserialize(reader);
  }

  if (id == 0x310240cc) {
    return AuctionBidLevel.deserialize(reader);
  }
  ...
  if (id == 0x7d5bd1f0) {
    return PaymentsStarGiftAuctionAcquiredGifts.deserialize(reader);
  }

  if (id == 0xd31bc45d) {
    return StarGiftActiveAuctionState.deserialize(reader);
  }
  ...
  if (id == 0x02e16c98) {
    return InputStarGiftAuction.deserialize(reader);
  }
  ...
  if (id == 0x36437737) {
    return StarGiftAttributeRarity.deserialize(reader);
  }

  if (id == 0xdbce6389) {
    return StarGiftAttributeRarityUncommon.deserialize(reader);
  }

  if (id == 0xf08d516b) {
    return StarGiftAttributeRarityRare.deserialize(reader);
  }

  if (id == 0x78fbf3a8) {
    return StarGiftAttributeRarityEpic.deserialize(reader);
  }

  if (id == 0xcef7e7a8) {
    return StarGiftAttributeRarityLegendary.deserialize(reader);
  }
  ...
  if (id == 0x2999beed) {
    return StatsPollStats.deserialize(reader);
  }

  if (id == 0x1fe9a9bf) {
    return InputAiComposeToneDefault.deserialize(reader);
  }

  if (id == 0x0773c080) {
    return InputAiComposeToneID.deserialize(reader);
  }

  if (id == 0x1fa01357) {
    return InputAiComposeToneSlug.deserialize(reader);
  }

  if (id == 0x0e0c35af) {
    return InputAiComposeToneSingleUse.deserialize(reader);
  }

  if (id == 0xcff63ea9) {
    return AiComposeTone.deserialize(reader);
  }

  if (id == 0x9bad6414) {
    return AiComposeToneDefault.deserialize(reader);
  }

  if (id == 0xc1f46103) {
    return AicomposeTonesNotModified.deserialize(reader);
  }

  if (id == 0x6c9d0efe) {
    return AicomposeTones.deserialize(reader);
  }

  if (id == 0xf1d628ec) {
    return AiComposeToneExample.deserialize(reader);
  }

  if (id == 0xdd1fbf93) {
    return BotsAccessSettings.deserialize(reader);
  }

  if (id == 0x445663a7) {
    return MessagesChatInviteJoinResultOk.deserialize(reader);
  }

  if (id == 0x61ca29d3) {
    return MessagesChatInviteJoinResultWebView.deserialize(reader);
  }

  if (id == 0xae152a69) {
    return JoinChatBotResultApproved.deserialize(reader);
  }

  if (id == 0x0efa0194) {
    return JoinChatBotResultDeclined.deserialize(reader);
  }

  if (id == 0x98a3a840) {
    return JoinChatBotResultQueued.deserialize(reader);
  }

  if (id == 0xd6e3b813) {
    return JoinChatBotResultWebView.deserialize(reader);
  }

  if (id == 0x933ca597) {
    return WebDomainException.deserialize(reader);
  }

  if (id == 0xc31c8f4e) {
    return AccountWebBrowserSettingsNotModified.deserialize(reader);
  }

  if (id == 0x79eb8cb3) {
    return AccountWebBrowserSettings.deserialize(reader);
  }

  if (id == 0x9b00622b) {
    return InputRichFilePhoto.deserialize(reader);
  }

  if (id == 0x83281dbd) {
    return InputRichFileDocument.deserialize(reader);
  }

  if (id == 0xe4c449fc) {
    return InputRichMessage.deserialize(reader);
  }

  if (id == 0xdacb836a) {
    return InputRichMessageHTML.deserialize(reader);
  }

  if (id == 0x004b572c) {
    return InputRichMessageMarkdown.deserialize(reader);
  }

  if (id == 0xbaf39d8b) {
    return RichMessage.deserialize(reader);
  }

  if (id == 0x76141ebd) {
    return CommunityPeer.deserialize(reader);
  }

  if (id == 0x7beafa85) {
    return CommunityPeerRequest.deserialize(reader);
  }
  ...
  if (id == 0x8d78512a) {
    return CommunitiesParticipantJoinedChats.deserialize(reader);
  }

  if (id == 0x4203998f) {
    return MessagesTranslatedRichMessage.deserialize(reader);
  }
  ...
  if (id == 0xadbb0f94) {
    return InvokeWithReCaptcha.deserialize(reader);
  }
  ...
  if (id == 0x2e7b4543) {
    return AccountGetCollectibleEmojiStatuses.deserialize(reader);
  }

  if (id == 0x19ba4a67) {
    return AccountGetPaidMessagesRevenue.deserialize(reader);
  }
  ...
  if (id == 0x67ed1f68) {
    return AccountConfirmBotConnection.deserialize(reader);
  }

  if (id == 0x56655768) {
    return AccountGetWebBrowserSettings.deserialize(reader);
  }

  if (id == 0x9adf82fe) {
    return AccountUpdateWebBrowserSettings.deserialize(reader);
  }

  if (id == 0x60ed4229) {
    return AccountToggleWebBrowserSettingsException.deserialize(reader);
  }

  if (id == 0x86a0765d) {
    return AccountDeleteWebBrowserSettingsExceptions.deserialize(reader);
  }
  ...
  if (id == 0xfc533372) {
    return UsersSuggestBirthday.deserialize(reader);
  }
  ...
  if (id == 0xb6c8c393) {
    return ContactsGetSponsoredPeers.deserialize(reader);
  }

  if (id == 0x139f63fb) {
    return ContactsUpdateContactNote.deserialize(reader);
  }
  ...
  if (id == 0x5a6d7395) {
    return MessagesReportMessagesDelivery.deserialize(reader);
  }

  if (id == 0x6f6f9c96) {
    return MessagesGetSavedDialogsByID.deserialize(reader);
  }

  if (id == 0xba4a3b5b) {
    return MessagesReadSavedHistory.deserialize(reader);
  }

  if (id == 0xd3e03124) {
    return MessagesToggleTodoCompleted.deserialize(reader);
  }

  if (id == 0x21a61057) {
    return MessagesAppendTodoList.deserialize(reader);
  }

  if (id == 0x8107455c) {
    return MessagesToggleSuggestedPostApproval.deserialize(reader);
  }

  if (id == 0x3ba47bff) {
    return MessagesGetForumTopics.deserialize(reader);
  }

  if (id == 0xaf0a4a08) {
    return MessagesGetForumTopicsByID.deserialize(reader);
  }

  if (id == 0xcecc1134) {
    return MessagesEditForumTopic.deserialize(reader);
  }

  if (id == 0x175df251) {
    return MessagesUpdatePinnedForumTopic.deserialize(reader);
  }

  if (id == 0x0e7841f0) {
    return MessagesReorderPinnedForumTopics.deserialize(reader);
  }

  if (id == 0x2f98c3d5) {
    return MessagesCreateForumTopic.deserialize(reader);
  }
  ...
  if (id == 0xf743b857) {
    return MessagesEditChatCreator.deserialize(reader);
  }

  if (id == 0x3b7d0ea6) {
    return MessagesGetFutureChatCreatorAfterLeave.deserialize(reader);
  }

  if (id == 0xa00f32b0) {
    return MessagesEditChatParticipantRank.deserialize(reader);
  }

  if (id == 0x35436bbc) {
    return MessagesDeclineUrlAuth.deserialize(reader);
  }
  ...
  if (id == 0xb8f106e3) {
    return MessagesSetBotGuestChatResult.deserialize(reader);
  }

  if (id == 0xa0b80cf8) {
    return MessagesDeleteParticipantReactions.deserialize(reader);
  }

  if (id == 0xe3b7f82c) {
    return MessagesDeleteParticipantReaction.deserialize(reader);
  }

  if (id == 0x55fb0996) {
    return MessagesGetPersonalChannelHistory.deserialize(reader);
  }

  if (id == 0x501569cf) {
    return MessagesGetRichMessage.deserialize(reader);
  }

  if (id == 0x1a542004) {
    return MessagesTranslateRichMessage.deserialize(reader);
  }

  if (id == 0x8d7ae6af) {
    return MessagesComposeRichMessageWithAI.deserialize(reader);
  }

  if (id == 0xba9ee679) {
    return MessagesRequestChatJoinWebView.deserialize(reader);
  }
  ...
  if (id == 0x4b12327b) {
    return ChannelsUpdatePaidMessagesPrice.deserialize(reader);
  }

  if (id == 0x167fc0a1) {
    return ChannelsToggleAutotranslation.deserialize(reader);
  }
  ...
  if (id == 0x8b89dfbd) {
    return BotsSetCustomVerification.deserialize(reader);
  }
  ...
  if (id == 0x213853a3) {
    return BotsGetAccessSettings.deserialize(reader);
  }

  if (id == 0x31813cd8) {
    return BotsEditAccessSettings.deserialize(reader);
  }

  if (id == 0xe71a4810) {
    return BotsSetJoinChatResults.deserialize(reader);
  }
  ...
  if (id == 0x9c9abcb1) {
    return PaymentsGetStarGiftUpgradePreview.deserialize(reader);
  }

  if (id == 0xaed6e4f5) {
    return PaymentsUpgradeStarGift.deserialize(reader);
  }

  if (id == 0x7f18176a) {
    return PaymentsTransferStarGift.deserialize(reader);
  }
  ...
  if (id == 0xb455a106) {
    return PaymentsGetSavedStarGift.deserialize(reader);
  }

  if (id == 0xd06e93a8) {
    return PaymentsGetStarGiftWithdrawalUrl.deserialize(reader);
  }

  if (id == 0x60eaefa1) {
    return PaymentsToggleChatStarGiftNotifications.deserialize(reader);
  }

  if (id == 0x1513e7b0) {
    return PaymentsToggleStarGiftsPinnedToTop.deserialize(reader);
  }

  if (id == 0x4fdc5ea7) {
    return PaymentsCanPurchaseStore.deserialize(reader);
  }
  ...
  if (id == 0x5c9ff4d6) {
    return PaymentsGetStarGiftAuctionState.deserialize(reader);
  }

  if (id == 0x6ba2cbec) {
    return PaymentsGetStarGiftAuctionAcquiredGifts.deserialize(reader);
  }
  ...
  if (id == 0xfd05dd00) {
    return PaymentsGetCraftStarGifts.deserialize(reader);
  }

  if (id == 0xb0f9684f) {
    return PaymentsCraftStarGift.deserialize(reader);
  }
  ...
  if (id == 0x7d0444bb) {
    return PhoneCreateConferenceCall.deserialize(reader);
  }

  if (id == 0x8ca60525) {
    return PhoneDeleteConferenceCallParticipants.deserialize(reader);
  }

  if (id == 0xc6701900) {
    return PhoneSendConferenceCallBroadcast.deserialize(reader);
  }

  if (id == 0xbcf22685) {
    return PhoneInviteConferenceCallParticipant.deserialize(reader);
  }

  if (id == 0x3c479971) {
    return PhoneDeclineConferenceCallInvite.deserialize(reader);
  }

  if (id == 0xee9f88a6) {
    return PhoneGetGroupCallChainBlocks.deserialize(reader);
  }

  if (id == 0xb1d11410) {
    return PhoneSendGroupCallMessage.deserialize(reader);
  }

  if (id == 0xe5afa56d) {
    return PhoneSendGroupCallEncryptedMessage.deserialize(reader);
  }

  if (id == 0xf64f54f7) {
    return PhoneDeleteGroupCallMessages.deserialize(reader);
  }

  if (id == 0x1dbfeca0) {
    return PhoneDeleteGroupCallParticipantMessages.deserialize(reader);
  }

  if (id == 0x6f636302) {
    return PhoneGetGroupCallStars.deserialize(reader);
  }

  if (id == 0x4167add1) {
    return PhoneSaveDefaultSendAs.deserialize(reader);
  }
  ...
  if (id == 0xc27dfa68) {
    return StatsGetPollStats.deserialize(reader);
  }
  ...
  if (id == 0xd069ccde) {
    return StoriesStartLive.deserialize(reader);
  }
  ...
  if (id == 0x4aa83913) {
    return AicomposeCreateTone.deserialize(reader);
  }

  if (id == 0x903bcf59) {
    return AicomposeUpdateTone.deserialize(reader);
  }

  if (id == 0x1782cbb1) {
    return AicomposeSaveTone.deserialize(reader);
  }

  if (id == 0xdd39316a) {
    return AicomposeDeleteTone.deserialize(reader);
  }

  if (id == 0xb2e8ba03) {
    return AicomposeGetTone.deserialize(reader);
  }

  if (id == 0xabd59201) {
    return AicomposeGetTones.deserialize(reader);
  }

  if (id == 0xd1b4ab14) {
    return AicomposeGetToneExample.deserialize(reader);
  }

  if (id == 0xa63859ec) {
    return CommunitiesCreate.deserialize(reader);
  }

  if (id == 0x736dcfea) {
    return CommunitiesTogglePeerLink.deserialize(reader);
  }

  if (id == 0xa663e830) {
    return CommunitiesGetJoinedCommunities.deserialize(reader);
  }

  if (id == 0xd766e3ea) {
    return CommunitiesToggleCommunityCollapsedInDialogs.deserialize(reader);
  }

  if (id == 0x93773344) {
    return CommunitiesGetPeerLinkRequests.deserialize(reader);
  }

  if (id == 0x8c8219a8) {
    return CommunitiesTogglePeerLinkRequestApproval.deserialize(reader);
  }

  if (id == 0xbfe3dd3d) {
    return CommunitiesToggleAllPeerLinkRequestApproval.deserialize(reader);
  }

  if (id == 0x9967ad0f) {
    return CommunitiesToggleParticipantBanned.deserialize(reader);
  }
  ...
  if (id == 0x8704f2bf) {
    return EphemeralReportMessage.deserialize(reader);
  }
  ...
  throw Exception(
    'This is a bug. Please report at https://github.com/psdkjoon/ptgc/issues.',
  );
}
